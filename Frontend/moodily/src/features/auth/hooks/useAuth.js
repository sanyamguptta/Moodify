...
export const useAuth = () => {
  ...
  // using useEffect() for calling handleGetMe() api for setting user in state variable
  useEffect( () => {
    handleGetMe(); // calling this function to hydrated user ie; used to call api of backend
  }, [])
